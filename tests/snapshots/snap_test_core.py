...
snapshots['test_get_analysis_enjambment_scansion_structure 1'] = GenericRepr('<Response 6822 bytes [200 OK]>')

snapshots['test_get_analysis_scansion 1'] = GenericRepr('<Response 8324 bytes [200 OK]>')

snapshots['test_get_analysis_scansion_structure 1'] = GenericRepr('<Response 2353 bytes [200 OK]>')
