...
def test_get_analysis_scansion(poem):
    operations = ["scansion"]
    ...
    "scansion": [
        ...
        "tokens": [
            ...
            "word": [
                ...
                { "syllable": "más", "is_stressed": True, "is_word_end": True }
            ],
            "stress_position": -1
            },
            {
            "word": [
                ...
                { "syllable": "ré", "is_stressed": True, "is_word_end": True }
            ],
            "stress_position": -1
            },
            {
            ...
            "word": [
                ...
                { "syllable": "mi", "is_stressed": False, "is_word_end": True }
            ],
            "stress_position": -2
            },
            { "symbol": "-" }
        ...
        "phonological_groups": [
            ...
            { "syllable": "ré", "is_stressed": True, "is_word_end": True },
            { "syllable": "más", "is_stressed": True, "is_word_end": True },
            { "syllable": "fiel", "is_stressed": True, "is_word_end": True },
            { "syllable": "a", "is_stressed": True },
            { "syllable": "mi", "is_stressed": False, "is_word_end": True }
        ],
        "rhythm": { "stress": "-+---++++-", "type": "pattern", "length": 10 }
        },
        {
        "tokens": [
            {
            "word": [
                { "syllable": "go", "is_stressed": True, "is_word_end": True }
            ],
            "stress_position": -1
            },
            {
            ...
            {
            "word": [
                { "syllable": "los", "is_stressed": False, "is_word_end": True }
            ],
            "stress_position": 0
            },
            {
            "word": [
                { "syllable": "pe", "is_stressed": False,
                  "has_sinaeresis": True },
                { "syllable": "o", "is_stressed": True },
                { "syllable": "res", "is_stressed": False, "is_word_end": True }
            ],
            "stress_position": -2
            },
            {
            ...
            "word": [
                ...
                { "syllable": "me", "is_stressed": False, "is_word_end": True }
            ],
            "stress_position": -2
            }
        ],
        "phonological_groups": [
            ...
            { "syllable": "los", "is_stressed": False, "is_word_end": True },
            { "syllable": "peo", "is_stressed": True,
              "sinaeresis_index": [1] },
            { "syllable": "res", "is_stressed": False, "is_word_end": True },
            { "syllable": "mo", "is_stressed": False },
            { "syllable": "men", "is_stressed": True },
            { "syllable": "tos", "is_stressed": False, "is_word_end": True },
            { "syllable": "a", "is_stressed": False },
            { "syllable": "rri", "is_stressed": True },
            { "syllable": "me", "is_stressed": False, "is_word_end": True }
        ],
        ...
        "tokens": [
            {
            "word": [
                { "syllable": "y", "is_stressed": False, "is_word_end": True }
            ],
            "stress_position": 0
            },
            {
            "word": [
                { "syllable": "no", "is_stressed": True, "is_word_end": True }
            ],
            "stress_position": -1
            },
            {
            ...
            "word": [
                { "syllable": "tra", "is_stressed": True,
                  "has_sinaeresis": True },
                { "syllable": "e", "is_stressed": False, "is_word_end": True }
            ],
            "stress_position": -2
            },
            {
        ...
        "tokens": [
            ...
            "word": [
                ...
                { "syllable": "lor", "is_stressed": True, "is_word_end": True }
            ],
            "stress_position": -1
            },
            {
            ...
            "word": [
                ...
                { "syllable": "jor", "is_stressed": True,"is_word_end": True }
            ],
            "stress_position": -1
            },
            {
...
def test_get_analysis_enjambment(poem):
    operations = ["enjambment"]
    output = get_analysis(poem, operations)
    assert output == {
        "enjambment": {
            0: { "type": "tmesis", "on": ["ami", "go"] },
            2: { "type": "sirrematic", "on": ["ADJ", "NOUN"] }
        }
    }


def test_get_analysis_enjambment_scansion(poem):
